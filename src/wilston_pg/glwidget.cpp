...
const char* textFileRead(char * _filename)
{
...
void setShaders() 
{
  ...
  const char * vv = textFileRead("./src/wilston_pg/shaders/normal_map.vert");
	const char * ff = textFileRead("./src/wilston_pg/shaders/normal_map.frag");
